...
public class Application implements IApplication {
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        /*
         *  Construct absolute path for the quote whith its tags
         */
        String absolutePath = WORKSPACE_DIRECTORY;
        for (String s : quote.getTags()) {
            absolutePath += '/' + s;
        }

        /**
         *  Contruct entire directory path including parents
         */
        File directoryQuote = new File(absolutePath);
        if (!directoryQuote.exists()) {
